    ...
    if (taskText !== "") {
        ...
        existingTasks.forEach(existingTask => {
            ...
            if(existingTask.textContent.toLowerCase() === taskText.toLowerCase()) {
                ...
                if (taskStyle.textDecoration === "line-through") {
        ...
        if (!isDuplicate) {
            ...
            deleteCell.innerHTML = '<button  class="deleteButton" onclick="deleteTask(this)">Delete</button>';
            ...
            Swal.fire({
                ...
                text: 'The task you are trying to add already exists.',
